...
**刷新状态面板:** 任何涉及选题/巡检/发布状态的操作, 先跑 `python tools/gen_status_board.py`
...
| 选题巡检/看面板 | 跑 `gen_status_board.py` → 打开 `状态面板.html` |
...
| `生产方法论.html` | 方案/概念设计（人类可读） |
| `生产操作手册.html` | 施工图/操作流程（人类可读） |
